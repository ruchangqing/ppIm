/*
 ...
 Source Server         : 192.168.125.171
 Source Server Type    : MySQL
 Source Server Version : 50734
 Source Host           : 192.168.125.171:3306
 Source Schema         : ppIm
...
CREATE TABLE `chat_message`  (
  ...
  `ope` tinyint(2) UNSIGNED NOT NULL DEFAULT 0 COMMENT '消息通道：0：好友消息，1：群消息，2：系统消息',
...
CREATE TABLE `group_join`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '群组申请表' ROW_FORMAT = Dynamic;
